...
DEVICE_DETAILS_URL = (
    "https://github.com/charlie508010/fireplace-csh-a01/blob/main/README.md"
...
class ConfigFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_select_type(self, user_input=None):
        ...
        _LOGGER.warning(
            "Include the previous log messages with any issue at https://github.com/charlie508010/fireplace-csh-a01/issues/",
        )
        if type_options:
